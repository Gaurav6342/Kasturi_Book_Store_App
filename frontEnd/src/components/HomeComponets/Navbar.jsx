...
//   console.log(authUser);
    ...
    // Create react hook again for theme 
             ...
             ` }>
                <div className="navbar ">
                    <div className="navbar-start">
                        ...
                        <a className="text-2xl font-bold cursor-pointer"> <span className='text-pink-500'>K</span>asturi <span className='text-pink-500'><sub>Books</sub></span> </a>
                    </div>
                    <div className="navbar-end space-x-3">
                        ...
                        <label className="swap swap-rotate">
                         ...
                         { authUser ?(<Logout/>) :           //     if user then show logout else show login
                            // *****  login button *****
                           ( 
                           <div className="">
